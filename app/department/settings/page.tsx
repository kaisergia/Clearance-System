    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-4 border-b border-outline-variant pb-6">
        ...
        <div>
          ...
          <p className="text-secondary font-body-md">Manage branding, security PIN, and preferences for {department?.name || "your department"}</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-surface-container-lowest p-6 rounded-2xl border border-outline-variant flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h3 className="font-bold text-base text-on-surface">Department Clearance Approval PIN</h3>
              <p className="text-xs text-secondary mt-0.5 leading-relaxed">
                Evaluators must enter this security passcode before clearing student requirements or approving submissions.
              </p>
            </div>
          </div>
          <button
      ...
      <SetPinModal
        ...
        officeIdOrKey={department?.id || "default"}
      />
    </div>
  );
}
