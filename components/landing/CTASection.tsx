    ...
    <section className="bg-[#9a1820] py-20 lg:py-28">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <button
          type="button"
          onClick={onOpenLogin}
          className="inline-flex items-center gap-2 bg-white text-[#c41e2a] hover:bg-gray-100 font-bold text-base px-10 py-4 rounded-lg transition-colors duration-150 shadow-lg"
        >
